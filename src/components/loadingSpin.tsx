export default function LoadingSpin({ loading, children }: { loading: boolean, children?: React.ReactNode; }) {
    if (loading)
        return <svg className="animate-spin w-12 h-12 text-indigo-400" viewBox="0 0 24 24">
